  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Dedicated Active Ethernet Last Mile</h3>
            </div>
            
            <div className="flex flex-col items-center text-center">
              <Globe className="w-16 h-16 mb-4" />
              <h3 className="text-xl font-semibold mb-2">Redundant And Direct International Upstream</h3>
            </div>
            
            <div className="flex flex-col items-center text-center">
              <Shield className="w-16 h-16 mb-4" />
              <h3 className="text-xl font-semibold mb-2">Resilient Backbone Structure</h3>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Long Term Commitment To ICT</h3>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-teal-500 text-white border-0 shadow-lg">
              <CardContent className="p-6">
                <p>
                  Each customer is given dedicated fiber access directly our POPs. Independent studies have shown that Active Ethernet is superior to GPON in almost every point including speed, reliability, security and fault recovery.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">NATIONAL PARTNERS</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">INTERNATIONAL PARTNERS</h2>
